...
internal object StorageColors {
    ...
    val SLOT_HOVER get() = if (isLightStorageOverlay) 0x60000000 else 0x80FFFFFF.toInt()
    val PANEL get() = if (isLightStorageOverlay) 0xE0F0F0F0.toInt() else 0xE0101010.toInt()
    val PANEL_OUTLINE get() = if (isLightStorageOverlay) 0xFF909090.toInt() else 0xFF505050.toInt()
    val PAGE_PANEL get() = if (isLightStorageOverlay) 0xD0E8E8E8.toInt() else 0xD0202020.toInt()
    val PAGE_PANEL_OUTLINE get() = if (isLightStorageOverlay) 0xFFA0A0A0.toInt() else 0xFF404040.toInt()
    val TITLE_EDIT_BACKGROUND get() = if (isLightStorageOverlay) 0xA0FFFFFF.toInt() else 0xA0080808.toInt()
    val TEXT_WHITE get() = if (isLightStorageOverlay) 0xFF202020.toInt() else 0xFFFFFFFF.toInt()
    val SCROLLBAR_TRACK get() = if (isLightStorageOverlay) 0xFFD0D0D0.toInt() else 0xFF242424.toInt()
    val SCROLLBAR_OUTLINE get() = if (isLightStorageOverlay) 0xFFB0B0B0.toInt() else 0xFF383838.toInt()
    val SCROLLBAR_KNOB get() = if (isLightStorageOverlay) 0xFF606060.toInt() else 0xFF808080.toInt()
    val SEARCH_BACKGROUND get() = if (isLightStorageOverlay) 0xE0F0F0F0.toInt() else 0xE0181818.toInt()
    val SEARCH_PLACEHOLDER get() = if (isLightStorageOverlay) 0xFF808080.toInt() else 0xFF555555.toInt()
    val PLAYER_PANEL get() = if (isLightStorageOverlay) 0xD0F0F0F0.toInt() else 0xD0181818.toInt()
    val SELECTOR_SLOT get() = if (isLightStorageOverlay) 0xFFE0E0E0.toInt() else 0xFF101010.toInt()
    val SLOT_BACKGROUND get() = if (isLightStorageOverlay) 0xFFC0C0C0.toInt() else 0xFF303030.toInt()
    val FOCUS_BACKDROP get() = if (isLightStorageOverlay) 0x80000000.toInt() else 0xB0000000.toInt()
}
